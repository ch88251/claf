...
public class BaseTitlePane extends JComponent {
    ...
    public void addNotify() {
        ...
        if (window != null) {
            ...
            setActive(CLAFUtilities.isWindowActive(window));
            installListeners();
        }
    }
    ...
    protected boolean isActive() {
        return (window == null) ? true : CLAFUtilities.isWindowActive(window);
    }
    ...
    public void paintText(Graphics g, int x, int y, String title) {
        ...
        CLAFUtilities.drawString(rootPane, g, title, x, y);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        String frameTitle = CLAFUtilities.getClippedText(getTitle(), fm, titleWidth);
