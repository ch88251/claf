...
public class BaseInternalFrameTitlePane extends BasicInternalFrameTitlePane implements ActionListener {
    ...
    public boolean isActive() {
        return CLAFUtilities.isActive(this);
    }
    ...
    public void paintPalette(Graphics g) {
        ...
        if (CLAFUtilities.isFrameActive(this)) {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getWindowTitleColors(), 0, 0, width, height);
        } else {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getWindowInactiveTitleColors(), 0, 0, width, height);
        }
    }

    public void paintBackground(Graphics g) {
        if (isActive()) {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getWindowTitleColors(), 0, 0, getWidth(), getHeight());
        } else {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getWindowInactiveTitleColors(), 0, 0, getWidth(), getHeight());
        }
    }
    ...
    public void paintText(Graphics g, int x, int y, String title) {
        ...
        CLAFUtilities.drawString(frame, g, title, x, y);
    }
    ...
    public void paintBorder(Graphics g) {
        ...
        CLAFUtilities.draw3DBorder(g, ColorHelper.brighter(borderColor, 20), ColorHelper.darker(borderColor, 10), 0, 0, getWidth(), getHeight());
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        boolean leftToRight = CLAFUtilities.isLeftToRight(frame);
        ...
        String frameTitle = CLAFUtilities.getClippedText(frame.getTitle(), fm, titleWidth);
