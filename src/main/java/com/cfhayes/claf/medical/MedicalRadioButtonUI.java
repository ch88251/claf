...
public class MedicalRadioButtonUI extends BaseRadioButtonUI {

    private static MedicalRadioButtonUI radioButtonUI = null;

    public static ComponentUI createUI(JComponent c) {
        if (radioButtonUI == null) {
            radioButtonUI = new MedicalRadioButtonUI();
        }
