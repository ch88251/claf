...
public class MedicalLookAndFeel extends AbstractLookAndFeel {

    private static MedicalDefaultTheme myTheme = null;
    ...
    public static void setTheme(Properties themesProps) {
        if (myTheme == null) {
            myTheme = new MedicalDefaultTheme();
        }
    ...
    public String getDescription() {
        return "The Medical Look and Feel";
    }
    ...
    public AbstractBorderFactory getBorderFactory() {
        return MedicalBorderFactory.getInstance();
    }

    public AbstractIconFactory getIconFactory() {
        return MedicalIconFactory.getInstance();
    }
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        Object[] uiDefaults = {
            ...
            // MedicalLookAndFeel classes
            "CheckBoxUI", MedicalCheckBoxUI.class.getName(),
            "RadioButtonUI", MedicalRadioButtonUI.class.getName(),
            "ButtonUI", MedicalButtonUI.class.getName(),
            "DesktopPaneUI", MedicalDesktopPaneUI.class.getName(),};
