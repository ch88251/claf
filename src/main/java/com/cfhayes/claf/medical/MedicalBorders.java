...
public class MedicalBorders extends BaseBorders {
    ...
    public static class RolloverToolButtonBorder implements Border, UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            Color loColor = MedicalLookAndFeel.getFrameColor();
            if (model.isEnabled()) {
    ...
    public static class InternalFrameBorder extends BaseInternalFrameBorder {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            Graphics2D g2D = (Graphics2D) g;
            Color titleColor = MedicalLookAndFeel.getWindowInactiveTitleBackgroundColor();
            if (isActive(c)) {
                titleColor = MedicalLookAndFeel.getWindowTitleBackgroundColor();
            }
            ...
            if (isActive(c)) {
                CLAFUtilities.fillHorGradient(g, MedicalLookAndFeel.getTheme().getWindowTitleColors(), 1, dw, dw, th + 1);
                CLAFUtilities.fillHorGradient(g, MedicalLookAndFeel.getTheme().getWindowTitleColors(), w - dw, dw, dw, th + 1);
                ...
                CLAFUtilities.fillHorGradient(g, MedicalLookAndFeel.getTheme().getWindowInactiveTitleColors(), 1, dw, dw, th + 1);
                CLAFUtilities.fillHorGradient(g, MedicalLookAndFeel.getTheme().getWindowInactiveTitleColors(), w - dw, dw, dw, th + 1);
            ...
            Color borderColor = MedicalLookAndFeel.getWindowInactiveBorderColor();
            if (isActive(c)) {
                borderColor = MedicalLookAndFeel.getWindowBorderColor();
            }
            ...
            // Using a light mint color instead of grey for medical theme
            g.setColor(new Color(240, 248, 245));
            g.drawLine(1, 1, w - 3, 1);
            g.drawLine(1, 1, 1, h - 2);
        }
    }
} // class MedicalBorders