...
public class BaseTableHeaderUI extends BasicTableHeaderUI {
    ...
    protected void paintBackground(Graphics g, Rectangle cellRect, int col) {
        ...
        if (col == rolloverCol && component.isEnabled()) {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getRolloverColors(), x, y, w, h);
        } else if (CLAFUtilities.isFrameActive(header)) {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getColHeaderColors(), x, y, w, h);
        } else {
            CLAFUtilities.fillHorGradient(g, AbstractLookAndFeel.getTheme().getInActiveColors(), x, y, w, h);
        }
    }
