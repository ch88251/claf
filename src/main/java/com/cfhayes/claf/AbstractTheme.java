...
public abstract class AbstractTheme extends MetalTheme {
    ...
    protected static String logoString = "Food";
    ...
    public void loadProperties() {
        ...
        try {
            String fileName = System.getProperty("user.home") + "/.claf/" + getPropertyFileName();
    ...
    public FontUIResource getControlTextFont() {
        if (controlFont == null) {
            if (CLAFUtilities.isLinux() && CLAFUtilities.isHiresScreen()) {
