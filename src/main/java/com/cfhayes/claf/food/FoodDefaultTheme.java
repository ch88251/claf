...
public class FoodDefaultTheme extends AbstractTheme {

    public FoodDefaultTheme() {
        super();
    ...
    public void setUpColor() {
        ...
        frameColor = new ColorUIResource(86, 75, 16);
        ...
        windowInactiveBorderColor = new ColorUIResource(86, 75, 16);
