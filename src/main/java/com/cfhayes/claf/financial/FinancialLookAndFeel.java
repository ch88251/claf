...
public class FinancialLookAndFeel extends AbstractLookAndFeel {

    private static FinancialDefaultTheme myTheme = null;
    ...
    public static void setTheme(Properties themesProps) {
        if (myTheme == null) {
            myTheme = new FinancialDefaultTheme();
        }
    ...
    public String getDescription() {
        return "The Financial Look and Feel";
    }
    ...
    public AbstractBorderFactory getBorderFactory() {
        return FinancialBorderFactory.getInstance();
    }

    public AbstractIconFactory getIconFactory() {
        return FinancialIconFactory.getInstance();
    }
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        Object[] uiDefaults = {
            ...
            // FinancialLookAndFeel classes
            "CheckBoxUI", FinancialCheckBoxUI.class.getName(),
            "RadioButtonUI", FinancialRadioButtonUI.class.getName(),
            "ButtonUI", FinancialButtonUI.class.getName(),
            "DesktopPaneUI", FinancialDesktopPaneUI.class.getName(),};
