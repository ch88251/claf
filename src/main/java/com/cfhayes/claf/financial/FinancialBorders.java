...
public class FinancialBorders extends BaseBorders {
    ...
    public static class RolloverToolButtonBorder implements Border, UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            Color loColor = FinancialLookAndFeel.getFrameColor();
            if (model.isEnabled()) {
    ...
    public static class InternalFrameBorder extends BaseInternalFrameBorder {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            Graphics2D g2D = (Graphics2D) g;
            Color titleColor = FinancialLookAndFeel.getWindowInactiveTitleBackgroundColor();
            if (isActive(c)) {
                titleColor = FinancialLookAndFeel.getWindowTitleBackgroundColor();
            }
            ...
            if (isActive(c)) {
                CLAFUtilities.fillHorGradient(g, FinancialLookAndFeel.getTheme().getWindowTitleColors(), 1, dw, dw, th + 1);
                CLAFUtilities.fillHorGradient(g, FinancialLookAndFeel.getTheme().getWindowTitleColors(), w - dw, dw, dw, th + 1);
                ...
                CLAFUtilities.fillHorGradient(g, FinancialLookAndFeel.getTheme().getWindowInactiveTitleColors(), 1, dw, dw, th + 1);
                CLAFUtilities.fillHorGradient(g, FinancialLookAndFeel.getTheme().getWindowInactiveTitleColors(), w - dw, dw, dw, th + 1);
            ...
            Color borderColor = FinancialLookAndFeel.getWindowInactiveBorderColor();
            if (isActive(c)) {
                borderColor = FinancialLookAndFeel.getWindowBorderColor();
            }
            ...
            // Using a light financial blue instead of grey for professional appearance
            g.setColor(new Color(245, 248, 252));
            g.drawLine(1, 1, w - 3, 1);
            g.drawLine(1, 1, 1, h - 2);
        }
    }
} // class FinancialBorders