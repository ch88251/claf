...
public class BaseSliderUI extends BasicSliderUI {
    ...
    public void paintTrack(Graphics g) {
        boolean leftToRight = CLAFUtilities.isLeftToRight(slider);
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            ...
            Color colors[] = null;
            if (!CLAFUtilities.isActive(slider)) {
            ...
            CLAFUtilities.fillHorGradient(g, colors, fillLeft + 2, fillTop + 2, fillRight - fillLeft - 2, fillBottom - fillTop - 2);
            Color cHi = ColorHelper.darker(colors[colors.length - 1], 5);
            Color cLo = ColorHelper.darker(colors[colors.length - 1], 10);
            CLAFUtilities.draw3DBorder(g, cHi, cLo, fillLeft + 1, fillTop + 1, fillRight - fillLeft - 1, fillBottom - fillTop - 1);
        } else {
            ...
            CLAFUtilities.fillVerGradient(g, colors, fillLeft + 2, fillTop + 2, fillRight - fillLeft - 2, fillBottom - fillTop - 2);
            Color cHi = ColorHelper.darker(colors[colors.length - 1], 5);
            Color cLo = ColorHelper.darker(colors[colors.length - 1], 10);
            CLAFUtilities.draw3DBorder(g, cHi, cLo, fillLeft + 1, fillTop + 1, fillRight - fillLeft - 1, fillBottom - fillTop - 1);
        }
