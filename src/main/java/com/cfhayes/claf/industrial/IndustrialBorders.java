...
public class IndustrialBorders extends BaseBorders {
    ...
    public static class RolloverToolButtonBorder implements Border, UIResource {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            ...
            Color loColor = IndustrialLookAndFeel.getFrameColor();
            if (model.isEnabled()) {
    ...
    public static class InternalFrameBorder extends BaseInternalFrameBorder {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
            Graphics2D g2D = (Graphics2D) g;
            Color titleColor = IndustrialLookAndFeel.getWindowInactiveTitleBackgroundColor();
            if (isActive(c)) {
                titleColor = IndustrialLookAndFeel.getWindowTitleBackgroundColor();
            }
            ...
            if (isActive(c)) {
                ...
                CLAFUtilities.fillHorGradient(g, IndustrialLookAndFeel.getTheme().getWindowInactiveTitleColors(), 1, dw, dw, th + 1);
                CLAFUtilities.fillHorGradient(g, IndustrialLookAndFeel.getTheme().getWindowInactiveTitleColors(), w - dw, dw, dw, th + 1);
            ...
            Color borderColor = IndustrialLookAndFeel.getWindowInactiveBorderColor();
            if (isActive(c)) {
                borderColor = IndustrialLookAndFeel.getWindowBorderColor();
            }
