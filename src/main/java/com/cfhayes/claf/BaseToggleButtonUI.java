...
public class BaseToggleButtonUI extends BasicToggleButtonUI {
    ...
    protected void paintBackground(Graphics g, AbstractButton b) {
        ...
        CLAFUtilities.fillHorGradient(g, colors, 1, 1, width - 2, height - 2);
    }
    ...
    protected void paintText(Graphics g, AbstractButton b, Rectangle textRect, String text) {
        ...
        if (model.isEnabled()) {
            ...
            CLAFUtilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x + offs, textRect.y + offs + fm.getAscent());
        } else {
            g.setColor(Color.white);
            CLAFUtilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x + 1, textRect.y + 1 + fm.getAscent());
            g.setColor(AbstractLookAndFeel.getDisabledForegroundColor());
            CLAFUtilities.drawStringUnderlineCharAt(b, g, text, mnemIndex, textRect.x, textRect.y + fm.getAscent());
        }
    }
